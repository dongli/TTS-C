...
contains
    ...
    subroutine NFWrap_CreateIrregular(filePath, card)
        character(*), intent(in) :: filePath
        type(FileCard), intent(out) :: card
    ...
    subroutine NFWrap_New1DVar(card, varName, dimName, longName, unitName, timeVariant)
        type(FileCard), intent(inout), target :: card
    ...
    subroutine NFWrap_Output1DVar(card, varName, varValue)
        type(FileCard), intent(inout), target :: card
        character(*), intent(in) :: varName
        real(8), intent(in) :: varValue(:)
    ...
    subroutine NFWrap_New2DVar(card, varName, dimName1, dimName2, &
    ...
    subroutine NFWrap_Output2DVar(card, varName, varValue)
        type(FileCard), intent(inout), target :: card
        character(*), intent(in) :: varName
        real(8), intent(in) :: varValue(:,:)
